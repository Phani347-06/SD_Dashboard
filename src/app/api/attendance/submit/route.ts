      ...
      const { data, error: resendErr } = await resend.emails.send({
        ...
        html: `
          <div style="font-family: sans-serif; padding: 20px; color: #333; line-height: 1.6;">
            ...
            <div style="background: #f0fdf4; padding: 15px; border-radius: 8px; border-left: 4px solid #008a00;">
               <p style="margin: 0; font-size: 13px;"><strong>Session Token:</strong> ${temp_session_id.substring(0,8)}...</p>
               <p style="margin: 5px 0 0 0; font-size: 13px;"><strong>Node ID:</strong> ${fingerprint_hash.substring(0,8)}</p>
            </div>
            <p style="font-size: 12px; color: #64748b; margin-top: 20px; border-top: 1px solid #e2e8f0; padding-top: 10px;">
